...
\begin{enumerate}
  \item If you reuse IVs, you risk ruining randomness and making the scheme deterministic, thus leaking message equality and ruining IND-CPA. This is especially critical in the case where an adversary acquires inside in the form of an IV.
  \item {\color{red} TODO other takeaways? Maybe about how to safely use this scheme for a two-man rule? What information should each person have? Or maybe let's just say Insights into what information each party in a two-man rule should possess follow in the Implementation Guidelines section.)}
\end{enumerate}
