...
TODO put a nice table here of the schemes and Y/N of whether they are IND-CPA or not... maybe also mention if they are generally weak (see last sentence of III.C.2.). \

TODO write general takeaways... number 1 is that if you reuse IVs, you risk ruining the randomness and making the scheme deterministic, thus leaking message equality and ruining IND-CPA. The difference is especially large when an adversary acquires some inside information such as an IV or $k$. (Makes sense?)\
